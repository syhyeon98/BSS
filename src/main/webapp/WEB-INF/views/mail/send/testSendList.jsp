...
<meta charset="UTF-8">
<title>받은 메일함</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/js/bootstrap5/css/mailStyle.css">
										...
										<div class="media">
											<div class="pull-left">
												<div class="controls">
													...
													<a href="javascript:void(0);" class="favourite text-muted hidden-sm-down" data-toggle="active">
														<i class="zmdi zmdi-${mail.mailImpo == '0' ? 'star-outline blue-star' : 'star blue-star'}"></i>
													</a>
												</div>
											...
											<div class="media-body">
												<div class="media-heading">
													<a href="#" class="m-r-10">받는 사람 : ${mail.receiveMailReceiver}</a>
