					...
					<div class="row">
						<div class="col-md-12">
							<div class="row mb-4">
								...
								<div class="col-md-3">
									<div class="row d-flex align-items-center">
										<div class="col-md-3">전세금대비 대출비율</div>
...
<div id="rentHouseLoanListArea" class="mt-4">
</div>
...
<script>
	...
	function ajaxDepositList(page) {
		...
		let setting = {
			url : `${pageContext.request.contextPath}/rentHouseLoan/rentHouseLoantList.do`,
			method : "POST",
			dataType : "text",
			data : JSON.stringify(data),
			contentType : "application/json",
			success : function(resp) {
				$('#rentHouseLoanListArea').html(resp);
			},
