...
public class AtchDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		File readFile = new File(atchFile.getOutStarCours());
		response.setContentLengthLong(atchFile.getOutAtchSize());
//		Content-Disposition: "inline[attachment];filename=\"{0}\"";
		String filename=URLEncoder.encode(atchFile.getOutOriginNm(),"UTF-8");
